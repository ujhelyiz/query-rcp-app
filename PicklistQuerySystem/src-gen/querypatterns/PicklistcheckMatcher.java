...
public class PicklistcheckMatcher extends BaseMatcher<PicklistcheckMatch> {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(PicklistcheckMatcher.class);
   ...
   * 
   */
  public Collection<PicklistcheckMatch> getAllMatches(final picklist.model.picklist.Picklist pP) {
   ...
   * 
   */
  public PicklistcheckMatch getOneArbitraryMatch(final picklist.model.picklist.Picklist pP) {
   ...
   * 
   */
  public boolean hasMatch(final picklist.model.picklist.Picklist pP) {
   ...
   * 
   */
  public int countMatches(final picklist.model.picklist.Picklist pP) {
   ...
   * 
   */
  public void forEachMatch(final picklist.model.picklist.Picklist pP, final IMatchProcessor<? super PicklistcheckMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final picklist.model.picklist.Picklist pP, final IMatchProcessor<? super PicklistcheckMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<PicklistcheckMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final picklist.model.picklist.Picklist pP) {
   ...
   * 
   */
  public PicklistcheckMatch newMatch(final picklist.model.picklist.Picklist pP) {
    return PicklistcheckMatch.newMatch(pP);
   ...
   * 
   */
  protected /* Set<picklist.model.picklist.Picklist> */Object rawAccumulateAllValuesOfP(final Object[] parameters) {
    Set<picklist.model.picklist.Picklist> results = new HashSet<picklist.model.picklist.Picklist>();
   ...
   * 
   */
  public /* Set<picklist.model.picklist.Picklist> */Object getAllValuesOfP() {
    return rawAccumulateAllValuesOfP(emptyArray());
  }
  
  @Override
  protected PicklistcheckMatch tupleToMatch(final Tuple t) {
    try {
      return PicklistcheckMatch.newMatch((picklist.model.picklist.Picklist) t.get(POSITION_P));
  ...
  protected PicklistcheckMatch arrayToMatch(final Object[] match) {
    try {
      return PicklistcheckMatch.newMatch((picklist.model.picklist.Picklist) match[POSITION_P]);
    } catch(ClassCastException e) {
  ...
  protected PicklistcheckMatch arrayToMatchMutable(final Object[] match) {
    try {
      return PicklistcheckMatch.newMutableMatch((picklist.model.picklist.Picklist) match[POSITION_P]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
